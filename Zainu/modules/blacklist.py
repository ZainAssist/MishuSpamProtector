...
from Zainu import SPAM_LOG_CHANNEL, SUDOERS, Zainu
from Zainu.modules.info import get_info
from Zainu.utils.db import (add_chat, add_user, blacklist_chat,
...
async def blacklist_func(_, message: Message):
    ...
    if id < 0:
        ...
        return await Zainu.send_message(SPAM_LOG_CHANNEL, text=msg)
    ...
    msg = f"**BLACKLIST EVENT**\n{await get_info(id)}"
    await Zainu.send_message(SPAM_LOG_CHANNEL, text=msg)
