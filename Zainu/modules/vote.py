...
from Zainu import NSFW_LOG_CHANNEL, SPAM_LOG_CHANNEL, SUDOERS, Zainu
from Zainu.core import ikb
from Zainu.utils.db import downvote, ignore_nsfw, upvote, user_voted
from Zainu.utils.misc import clean, get_file_unique_id


@Zainu.on_callback_query(filters.regex(r"^upvote_"))
...
@Zainu.on_callback_query(filters.regex(r"^downvote_"))
