...
from Zainu.utils.db import (disable_nsfw, disable_spam, enable_nsfw,
...
@Zainu.on_message(filters.command("nsfw_scan"), group=3)
...
@Zainu.on_message(filters.command("spam_scan"), group=3)
