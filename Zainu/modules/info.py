...
from Zainu import SUDOERS, Zainu
from Zainu.utils.db import (add_chat, add_user, chat_exists,
...
@MishuSpamProtectorbot [CHAT_ID/Username|USER_ID/Username]
"""
...
@Zainu.on_message(filters.command("info"), group=3)
